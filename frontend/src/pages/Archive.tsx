...
export default function Archive() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">Archived Notes</h1>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16">
            <p className="text-gray-500 dark:text-gray-400 text-lg">No archived notes</p>
          </div>
        ) : (
