...
export default function NoteModal({ note, onClose, onAction }) {
  const labels = extractHashtags(note.content);
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-scrollable">
          <div className="modal-category-chip">{note.category}</div>
          ...
          <div className="modal-timestamps">
            <p><strong>Created:</strong> <span>{format(new Date(note.createdAt), 'PPpp')}</span></p>
            <p><strong>Last Modified:</strong> <span>{format(new Date(note.updatedAt), 'PPpp')}</span></p>
          </div>
        ...
        <div className="modal-actions">
          ...
          {isDeleted && (
            <>
              ...
              <button onClick={() => onAction(note.id, 'permanent-delete')} className="btn btn-delete">
                Delete Permanently
              </button>
            </>
          )}
